...
- **Offline coverage:** Maintain a fast `uv run pytest -m offline` suite that exercises configuration layering, logging, startup checks, and risk-manager tooling without requiring network access.
